...
const uint16_t PROGMEM F_SCLP_combo[] = {KC_HASH, KC_P, COMBO_END}; // SCREEN shot SELECTION to clipboard
const uint16_t PROGMEM F_SCAP_combo[] = {KC_HASH, KC_V, COMBO_END}; //  SCREEN shot SELECTION to file
...
const uint16_t PROGMEM Hacut_combo[] = {KC_SLSH, KC_QUOT, COMBO_END}; // ´ acute (dead key)
...
const uint16_t PROGMEM Hcirc_combo[] = {KC_DOT, KC_QUOT, COMBO_END}; // ˆ circumflex (dead key)
...
const uint16_t PROGMEM H_Ch_combo[] = {RALT_T(KC_I), RCTL_T(KC_C), COMBO_END}; // TYPE "ch" // for HD Gold
const uint16_t PROGMEM H_Wh_combo[] = {KC_W, KC_Y, COMBO_END}; // TYPE "wh"
...
//const uint16_t PROGMEM Macro_combo[] = {KC_HASH, KC_B, COMBO_END}; // some demonstrator macro placeholder
...
// TWO HANDS
const uint16_t PROGMEM Hdquo_combo[] = {KC_EQL, KC_DQUO, COMBO_END};  // "|" insert between double quote
const uint16_t PROGMEM Hdbrc_combo[] = {KC_MINS, KC_Y, COMBO_END};  // [|] insert between double BRACKET
...
*/
            ...
            case HC_there_5gram: // TYPE "there" #7
                ...
                combo_on = combo_index; // may add "'s " in matrix_scan_user_process_combo
                break;
            case HC_theyre_7gram: // TYPE "they're" // this should be a linger add text?
                SEND_STRING("they're");
                break;
