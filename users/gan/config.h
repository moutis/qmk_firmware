...
#define ADAPTIVE_TERM TAPPING_TERM/2 // default time between keystrokes allowed for adaptives
    ...
    #define COMBO_HOLD (COMBO_TERM*4) // time to hold to trigger combo
#endif
...
#define LINGER_TIME TAPPING_TERM * 1.75 // how long to hold before a time-depentant behavior begins
