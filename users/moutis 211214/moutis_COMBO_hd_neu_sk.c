...
const uint16_t PROGMEM H_Idg_combo[] = {KC_D, RCTL_T(KC_H), COMBO_END}; // TYPE "I'd"+"'ve " for Gold/Neu
const uint16_t PROGMEM H_Illg_combo[] = {KC_L, RCTL_T(KC_H), COMBO_END}; // TYPE "I'll"+"'ve " for Gold/Neu
const uint16_t PROGMEM H_Img_combo[] = {KC_M, RCTL_T(KC_H), COMBO_END}; // TYPE "I'm " for Gold/Neu
const uint16_t PROGMEM H_Ivg_combo[] = {KC_V, RCTL_T(KC_H), COMBO_END}; // TYPE "I've " for Gold/Neu

const uint16_t PROGMEM H_Icap_combo[] = {RALT_T(KC_C), RCTL_T(KC_I), COMBO_END}; // TYPE "I"+"'m"
...
const uint16_t PROGMEM H_Iv_combo[] = {KC_V, RCTL_T(KC_I), COMBO_END}; // TYPE "I've "
