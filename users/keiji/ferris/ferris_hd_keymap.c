...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[1] = LAYOUT(KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_DQUO, KC_QUOT, LCTL_T(KC_C), KC_TRNS, KC_TRNS, KC_TRNS, LT(5,KC_B), KC_TRNS, KC_TRNS, KC_TRNS, RALT_T(KC_I), RCTL_T(KC_H), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_K, KC_TRNS, KC_TRNS, KC_TRNS, KC_Y, KC_W, KC_TRNS, LT(6,KC_R), KC_TRNS, KC_TRNS),
	...
	[3] = LAYOUT(KC_Q, KC_Z, RSA(KC_5), LSA(KC_7), LALT(KC_7), LALT(KC_4), KC_DLR, A(S(KC_2)), RALT(KC_3), LALT(KC_Y), KC_LT, KC_LBRC, KC_LPRN, KC_LCBR, LALT(KC_8), RALT(KC_1), RSFT_T(KC_PAST), RGUI_T(KC_PEQL), RALT_T(KC_PPLS), RCTL_T(KC_PSLS), KC_GT, KC_RBRC, KC_RPRN, KC_RCBR, RALT(KC_5), KC_UNDS, KC_PIPE, KC_AMPR, KC_CIRC, KC_PERC, SK_DELWDL, SK_DELWDR, KC_TRNS, KC_TRNS),
	[4] = LAYOUT(KC_F9, KC_F10, KC_F11, KC_F12, KC_F13, KC_GRV, KC_6, KC_7, KC_8, KC_BSLS, LCTL_T(KC_F5), LALT_T(KC_F6), LGUI_T(KC_F7), LSFT_T(KC_F8), KC_F14, KC_SCLN, RSFT_T(KC_1), RGUI_T(KC_5), RALT_T(KC_9), RCTL_T(KC_SLSH), KC_F1, KC_F2, KC_F3, KC_F4, KC_INS, KC_COMM, KC_2, KC_3, KC_4, KC_EQL, KC_NO, TG(5), KC_0, KC_DOT),
	...
	[7] = LAYOUT(RESET, KC_NO, KC_EJCT, KC_NO, LCA(KC_DEL), SK_KILL, KC_NO, AG_NORM, AG_SWAP, KC_NO, KC_MPRV, KC_MNXT, KC_MUTE, KC_VOLU, KC_NO, KC_NO, HD_L_Bronze, HD_L_Gold, HD_L_QWERTY, KC_BRIU, KC_MRWD, KC_MFFD, KC_MPLY, KC_VOLD, KC_NLCK, HD_AdaptKeyToggle, KC_NO, KC_NO, KC_NO, KC_BRID, KC_TRNS, KC_TRNS, CG_NORM, CG_SWAP)
};
