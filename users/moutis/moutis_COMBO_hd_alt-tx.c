...
const uint16_t PROGMEM F_MAC_combo[] = {KC_LBRC, KC_M, COMBO_END}; // Set MAC OS env var
const uint16_t PROGMEM F_WIN_combo[] = {KC_LBRC, KC_W, COMBO_END}; // Set WIN OS env var
const uint16_t PROGMEM F_KILL_combo[] = {KC_LBRC, KC_DOT, COMBO_END}; // Force quit
const uint16_t PROGMEM F_SCLP_combo[] = {KC_LBRC, KC_G, COMBO_END}; // SCREEN shot SELECTION to clipboard
const uint16_t PROGMEM F_SCAP_combo[] = {KC_LBRC, KC_H, COMBO_END}; //  SCREEN shot SELECTION to file
const uint16_t PROGMEM F_CAPS_combo[] = {KC_H, KC_I, COMBO_END}; // CAPS LOCK
const uint16_t PROGMEM F_LANG1_combo[] = {KC_N, KC_E, COMBO_END}; // LANG1/KANA
const uint16_t PROGMEM F_LANG2_combo[] = {KC_N, KC_I, COMBO_END}; // LANG2/EISUU
...
const uint16_t PROGMEM Hacut_combo[] = {KC_X, KC_RBRC, COMBO_END}; // ´ acute (dead key)
const uint16_t PROGMEM Hcirc_combo[] = {KC_U, KC_RBRC, COMBO_END}; // ˆ circumflex (dead key)
const uint16_t PROGMEM Hgrv_combo[] = {KC_P, KC_RBRC, COMBO_END}; // ` grave

const uint16_t PROGMEM Hmacr_combo[] = {KC_P, KC_X, COMBO_END}; // - macron (dead key)
...
const uint16_t PROGMEM Hodot_combo[] = {KC_QUOT, KC_X, COMBO_END}; // ˚ hi o dot over char (dead key)
...
const uint16_t PROGMEM H_Z_combo[] = {KC_X, KC_U, COMBO_END}; // TYPE "z"
...
const uint16_t PROGMEM Henye_combo[] = {KC_G, KC_M, COMBO_END}; // ˜ enye (dead key)
...
const uint16_t PROGMEM H_QU_combo[] = {KC_C, KC_COMM, COMBO_END}; // TYPE "qu"
const uint16_t PROGMEM H_GL_combo[] = {KC_G, KC_M, COMBO_END}; // TYPE "gl"
const uint16_t PROGMEM H_CL_combo[] = {KC_M, KC_K, COMBO_END}; // TYPE "kl"

const uint16_t PROGMEM Hldaq_combo[] = {KC_W, KC_COMM, COMBO_END}; // «
const uint16_t PROGMEM Hrdaq_combo[] = {KC_W, KC_DOT, COMBO_END}; // »
...
const uint16_t PROGMEM quotq_combo[] = {KC_QUOT, KC_MINS, COMBO_END};  // "|" insert between double quote
...
//    [HC_2BRAK] = COMBO_ACTION(Hdbrak_combo), // left+right bracket, insertion in the middle
    ...
    [HC_TYPE_CL] = COMBO_ACTION(H_CL_combo),
