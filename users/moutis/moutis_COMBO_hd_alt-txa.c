...
const uint16_t PROGMEM F_KILL_combo[] = {KC_X, KC_MINS, COMBO_END}; // Force quit
...
const uint16_t PROGMEM F_SCLP_combo[] = {KC_J, KC_F, COMBO_END}; // SCREEN shot SELECTION to clipboard
const uint16_t PROGMEM F_SCAP_combo[] = {KC_J, KC_V, COMBO_END}; //  SCREEN shot SELECTION to file
const uint16_t PROGMEM F_CAPS_combo[] = {KC_C, KC_U, COMBO_END}; // CAPS LOCK
const uint16_t PROGMEM H_CAPS_combo[] = {KC_D, KC_A, COMBO_END}; // CAPS LOCK for when I get home row combos working after merging Sevanteri's fork.  (Karabiner does L+R shift now)

//  (22) keypad combos
const uint16_t PROGMEM P0E_combo[] = {KC_P0, KC_PEQL, COMBO_END};
const uint16_t PROGMEM PCME_combo[] = {KC_COMM, KC_PEQL, COMBO_END};
const uint16_t PROGMEM PCM1_combo[] = {KC_COMM, KC_P1, COMBO_END};
const uint16_t PROGMEM PCM2_combo[] = {KC_COMM, KC_P2, COMBO_END};
...
const uint16_t PROGMEM Hbsls_combo[] = {KC_DQUO, KC_SLSH, COMBO_END}; // \ backslash
...
const uint16_t PROGMEM Helip_combo[] = {KC_MINS, KC_Y, COMBO_END}; // … elipses
const uint16_t PROGMEM Hequal_combo[] = {KC_W, KC_Y, COMBO_END}; // = equal

// spatially arranged characters and diacritics
const uint16_t PROGMEM Hexlm_combo[] = {KC_QUES, KC_COMM, COMBO_END}; //
const uint16_t PROGMEM Hhash_combo[] = {KC_COMM, KC_DOT, COMBO_END}; //
const uint16_t PROGMEM Hat_combo[] = {KC_DOT, KC_DQUO, COMBO_END}; //
const uint16_t PROGMEM Htic_combo[] = {KC_QUOT, KC_QUES, COMBO_END}; // ` tic (not dead key grave)
const uint16_t PROGMEM Hacut_combo[] = {KC_QUOT, KC_DQUO, COMBO_END}; // ´ acute (dead key)
const uint16_t PROGMEM Hcirc_combo[] = {KC_QUOT, KC_DOT, COMBO_END}; // ˆ circumflex (dead key)
const uint16_t PROGMEM Hgrv_combo[] = {KC_QUOT, KC_COMM, COMBO_END}; // ` grave (dead key)
...
const uint16_t PROGMEM Hmacr_combo[] = {KC_DOT, KC_W, COMBO_END}; // - macron (dead key)ā
...
const uint16_t PROGMEM H_LM_combo[] = {KC_G, KC_M, COMBO_END}; // TYPE "lm" (adaptive M is L after G)
const uint16_t PROGMEM H_tion_combo[] = {KC_J, KC_K, COMBO_END}; // TYPE "tion"
...
const uint16_t PROGMEM Htab_combo[] = {KC_F, KC_V, COMBO_END}; // tab HANDS DOWN
const uint16_t PROGMEM Henye_combo[] = {KC_G, KC_F, COMBO_END}; // ˜ enye (dead key)

// LOWER ROW

// FUNCTIONS Spatially arranged
const uint16_t PROGMEM Hent_combo[] = {KC_P, KC_B, COMBO_END}; // ENTER
const uint16_t PROGMEM Hclose_combo[] = {KC_L, KC_B, COMBO_END}; // close
const uint16_t PROGMEM Hquit_combo[] = {KC_C, KC_B, COMBO_END}; // quit
const uint16_t PROGMEM Hfind_combo[] = {KC_F, KC_K, COMBO_END}; // find
const uint16_t PROGMEM Hsall_combo[] = {KC_X, KC_P, COMBO_END}; // select all
...
const uint16_t PROGMEM Hpste_combo[] = {KC_L, KC_P, COMBO_END}; // paste
const uint16_t PROGMEM Hpstm_combo[] = {KC_P, KC_C, COMBO_END}; // paste-match

// TWO HANDS
const uint16_t PROGMEM Hdquo_combo[] = {KC_V, KC_DQUO, COMBO_END};  // "|" insert between double quote
const uint16_t PROGMEM Hdbrc_combo[] = {KC_V, KC_QUOT, COMBO_END};  // [|] insert between double BRACKET


enum my_combos {
    HC_BSLS, // \ backslash: SIMPLE COMBO must be first-used as FALSE for combo_on
    HC_EQL, // = equal
    HC_HASH, // #
    HC_EXLM, // !
    HC_AT, // @
