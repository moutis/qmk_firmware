...
const uint16_t PROGMEM F_KILL_combo[] = {KC_X, KC_DOT, COMBO_END}; // Force quit
const uint16_t PROGMEM F_MAC_combo[] = {KC_MINS, KC_M, COMBO_END}; // Set MAC OS env var
const uint16_t PROGMEM F_WIN_combo[] = {KC_MINS, KC_V, COMBO_END}; // Set WIN OS env var
const uint16_t PROGMEM F_SCLP_combo[] = {KC_TAB, KC_F, COMBO_END}; // SCREEN shot SELECTION to clipboard
const uint16_t PROGMEM F_SCAP_combo[] = {KC_TAB, KC_M, COMBO_END}; //  SCREEN shot SELECTION to file
const uint16_t PROGMEM F_CAPS_combo[] = {KC_D, KC_W, COMBO_END}; // CAPS LOCK
...
const uint16_t PROGMEM F_LANG1_combo[] = {KC_L, KC_SLSH, COMBO_END}; // LANG1/KANA
const uint16_t PROGMEM F_LANG2_combo[] = {KC_L, KC_W, COMBO_END}; // LANG2/EISUU
...
// UPPER ROW
const uint16_t PROGMEM Hquot_combo[] = {KC_QUOT, KC_U, COMBO_END}; // "
const uint16_t PROGMEM Hdquo_combo[] = {KC_QUOT, KC_HASH, COMBO_END};  // "|" insert between double quote
const uint16_t PROGMEM Hat_combo[] = {KC_HASH, KC_J, COMBO_END}; // @

const uint16_t PROGMEM H_Q_combo[] = {KC_U, KC_K, COMBO_END}; // TYPE "q"
const uint16_t PROGMEM H_Z_combo[] = {KC_K, KC_J, COMBO_END}; // TYPE "z"

// spatially arranged characters and diacritics
const uint16_t PROGMEM Hacut_combo[] = {KC_QUOT, KC_J, COMBO_END}; // ´ acute (dead key)
const uint16_t PROGMEM Hgrv_combo[] = {KC_QUOT, KC_K, COMBO_END}; // ` grave
const uint16_t PROGMEM Hdier_combo[] = {KC_U, KC_J, COMBO_END}; // ¨ dieresis (dead key)
const uint16_t PROGMEM Hmacr_combo[] = {KC_U, KC_HASH, COMBO_END}; // - macron (dead key)ā
const uint16_t PROGMEM Hcirc_combo[] = {KC_K, KC_HASH, COMBO_END}; // ˆ circumflex (dead key)

// LOWER ROW
// SYMBOLS spatially arranged
const uint16_t PROGMEM Hndsh_combo[] = {KC_MINS, KC_W, COMBO_END}; // – n dash
const uint16_t PROGMEM Hmdsh_combo[] = {KC_MINS, KC_SLSH, COMBO_END}; // — m dash
const uint16_t PROGMEM Htild_combo[] = {KC_MINS, KC_COMM, COMBO_END}; // ~ tilde (not the dead one)

const uint16_t PROGMEM Hbsls_combo[] = {KC_SLSH, KC_W, COMBO_END}; // \ backslash
const uint16_t PROGMEM commdot_combo[] = {KC_SLSH, KC_COMM, COMBO_END}; // ; semicolon
const uint16_t PROGMEM Hcoln_combo[] = {KC_COMM, KC_DOT, COMBO_END}; // : colon
const uint16_t PROGMEM Hexlm_combo[] = {KC_SLSH, KC_DOT, COMBO_END}; // ! exclamation
const uint16_t PROGMEM Hunds_combo[] = {KC_W, KC_COMM, COMBO_END}; // _ underscore
const uint16_t PROGMEM Helip_combo[] = {KC_W, KC_DOT, COMBO_END}; // … elipses
...
const uint16_t PROGMEM Henye_combo[] = {KC_G, KC_F, COMBO_END}; // ˜ enye (dead key)

// TEXT ENTRY (ANY ROW/ MIXED ROWS
const uint16_t PROGMEM H_GL_combo[] = {KC_G, KC_M, COMBO_END}; // TYPE "gl"
const uint16_t PROGMEM H_LM_combo[] = {KC_M, KC_F, COMBO_END}; // TYPE "lm"
//const uint16_t PROGMEM H_BL_combo[] = {KC_F, KC_B, COMBO_END}; // TYPE "bl"
const uint16_t PROGMEM H_tion_combo[] = {KC_MINS, KC_DOT, COMBO_END}; // TYPE "tion"
...
const uint16_t PROGMEM Hquit_combo[] = {KC_C, KC_B, COMBO_END}; // quit
...
const uint16_t PROGMEM Hundo_combo[] = {KC_X, KC_C, COMBO_END}; // undo
const uint16_t PROGMEM Hcut_combo[] = {KC_X, KC_L, COMBO_END}; // cut
const uint16_t PROGMEM Hcopy_combo[] = {KC_L, KC_C, COMBO_END}; // copy
const uint16_t PROGMEM Hpste_combo[] = {KC_L, KC_D, COMBO_END}; // paste
const uint16_t PROGMEM Hpstm_combo[] = {KC_C, KC_D, COMBO_END}; // paste-match

// TWO HANDS

const uint16_t PROGMEM Hdbrc_combo[] = {KC_V, KC_MINS, COMBO_END}; // [|] insert between dble brace
const uint16_t PROGMEM Hlsaq_combo[] = {KC_V, KC_COMM, COMBO_END}; // ‹
const uint16_t PROGMEM Hrsaq_combo[] = {KC_V, KC_DOT, COMBO_END}; // ›
const uint16_t PROGMEM Hldaq_combo[] = {KC_D, KC_COMM, COMBO_END}; // «
const uint16_t PROGMEM Hrdaq_combo[] = {KC_D, KC_DOT, COMBO_END}; // »
...
combo_t key_combos[COMBO_COUNT] = {
    ...
    [HC_EXLM] = COMBO(Hexlm_combo, KC_EXLM), // ! exclamation
...
// HANDSDOWN
//    [HC_LBRC] = COMBO(Hlbrc_combo, KC_LBRC), // [ These are used for quotes in Japanese
//    [HC_RBRC] = COMBO(Hrbrc_combo, KC_RBRC), // ]
