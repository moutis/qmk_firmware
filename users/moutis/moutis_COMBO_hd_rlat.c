...
const uint16_t PROGMEM H_Japan_combo[] = {KC_V, KC_M, KC_G, COMBO_END}; // TYPE EnglishComboTapE
...
const uint16_t PROGMEM F_SCAP_combo[] = {KC_V, KC_M, KC_G, KC_LPRN, COMBO_END}; //  SCREEN shot SELECTION to file
...
const uint16_t PROGMEM F_ESC_combo[] = {KC_P, KC_X, COMBO_END}; // ESCape
...
const uint16_t PROGMEM Hunds_combo[] = {KC_U, KC_B, COMBO_END}; // _ underscore
const uint16_t PROGMEM Hequal_combo[] = {KC_Y, KC_B, COMBO_END}; // = equal
...
const uint16_t PROGMEM Hques_combo[] = {KC_SLSH, KC_J, COMBO_END}; // ?
const uint16_t PROGMEM Hdquo_combo[] = {KC_J, KC_QUOT, COMBO_END}; // " DOUBLE QUOTE
const uint16_t PROGMEM Htic_combo[] = {KC_SLSH, KC_QUOT, COMBO_END}; // ` tic (not dead key grave)
...
const uint16_t PROGMEM Henye_combo[] = {KC_V, KC_G, COMBO_END}; // ˜ enye (dead key) (ñ only?)
...
const uint16_t PROGMEM H_Z_combo[] = {KC_V, KC_M, COMBO_END}; // TYPE "z"
...
const uint16_t PROGMEM H_Wh_combo[] = {KC_V, KC_G, COMBO_END}; // TYPE "wh"
...
const uint16_t PROGMEM H_there_combo[] = {RSFT_T(KC_T), LT(L_FN_NUM,KC_SLSH), COMBO_END}; // TYPE "there" #7 + 's
const uint16_t PROGMEM H_here_combo[] = {RCTL_T(KC_H), LT(L_FN_NUM,KC_SLSH), COMBO_END}; // TYPE "here" #5 + 's
const uint16_t PROGMEM H_where_combo[] = {KC_W, LT(L_FN_NUM,KC_SLSH), COMBO_END}; // "where" + 's
...
const uint16_t PROGMEM Hent_combo[] = {KC_D, KC_X, COMBO_END}; // ENTER
const uint16_t PROGMEM Hent2_combo[] = {KC_L, KC_D, KC_X,  COMBO_END}; // hard-ENTER

// LOWER ROW

// SEMANTIC FUNCTIONS Spatially arranged  ** uses SemKeys **
const uint16_t PROGMEM Hclose_combo[] = {KC_L, KC_X, COMBO_END}; // close
const uint16_t PROGMEM Hquit_combo[] = {KC_F, KC_X, COMBO_END}; // quit
...
//const uint16_t PROGMEM Hcut_combo[] = {KC_P, KC_L, KC_D, COMBO_END}; // cut
...
//    [HC_CUT] = COMBO(Hcut_combo, SK_CUT), // using combo hold
    [HC_COPY] = COMBO_ACTION(Hcopy_combo),
//    [HC_PSTM] = COMBO(Hpstm_combo, SK_PSTM),  // using combo hold
