...
const uint16_t PROGMEM F_KILL_combo[] = {KC_HASH, KC_DOT, COMBO_END}; // Force quit
const uint16_t PROGMEM F_SCLP_combo[] = {KC_HASH, KC_G, COMBO_END}; // SCREEN shot SELECTION to clipboard
const uint16_t PROGMEM F_SCAP_combo[] = {KC_HASH, KC_H, COMBO_END}; //  SCREEN shot SELECTION to file
...
const uint16_t PROGMEM Hmacr_combo[] = {KC_K, KC_X, COMBO_END}; // - macron (dead key)
const uint16_t PROGMEM Hdier_combo[] = {KC_U, KC_X, COMBO_END}; // ¨ dieresis (dead key)
const uint16_t PROGMEM Hstrk_combo[] = {KC_K, KC_SLSH, COMBO_END}; // — strikethrough (dead key)
const uint16_t PROGMEM Hodot_combo[] = {KC_U, KC_SLSH, COMBO_END}; // ˚ hi o dot over char (dead key)

const uint16_t PROGMEM Hbsls_combo[] = {KC_X, KC_SLSH, COMBO_END}; // \ backslash
const uint16_t PROGMEM H_Q_combo[] = {KC_P, KC_SCLN, COMBO_END}; // TYPE "q"
const uint16_t PROGMEM H_Z_combo[] = {KC_SCLN, KC_COMM, COMBO_END}; // TYPE "z"

const uint16_t PROGMEM Hndsh_combo[] = {KC_MINS, KC_M, COMBO_END}; // – n dash
...
const uint16_t PROGMEM Hcoln_combo[] = {KC_SCLN, KC_DOT, COMBO_END}; // : colon
const uint16_t PROGMEM Helip_combo[] = {KC_P, KC_DOT, COMBO_END}; // … elipses

// Bigram and other multi-output thingies
const uint16_t PROGMEM H_QU_combo[] = {KC_K, KC_U, COMBO_END}; // TYPE "qu"
const uint16_t PROGMEM H_GL_combo[] = {KC_G, KC_C, COMBO_END}; // TYPE "gl"
const uint16_t PROGMEM H_CL_combo[] = {KC_C, KC_M, COMBO_END}; // TYPE "cl"

const uint16_t PROGMEM Hldaq_combo[] = {KC_V, KC_COMM, COMBO_END}; // «
const uint16_t PROGMEM Hrdaq_combo[] = {KC_V, KC_DOT, COMBO_END}; // »
