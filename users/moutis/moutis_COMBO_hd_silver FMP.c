...
const uint16_t PROGMEM Hdbrc_combo[] = {KC_MINS, KC_V, COMBO_END};  // [|] insert between double BRACKET

// Major
const uint16_t PROGMEM HUM_combo[] = {KC_M, KC_U, COMBO_END};  // Ü
const uint16_t PROGMEM HOM_combo[] = {KC_M, KC_O, COMBO_END};  // Ö
const uint16_t PROGMEM HUK_combo[] = {KC_P, KC_U, COMBO_END};  // Ů
const uint16_t PROGMEM HOK_combo[] = {KC_P, KC_O, COMBO_END};  // O̊
