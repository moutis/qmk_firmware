...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [L_FN_NUM] = LAYOUT_split_3x5_2(
        ...
        KC_F1, KC_F2, KC_F3, KC_F4, KC_INS, KC_COMM, KC_4, KC_5, KC_6, KC_EQL,
                KC_SCLN, TG(L_NUMPAD), KC_0, KC_DOT),
    [L_NUMPAD] = LAYOUT_split_3x5_2(
        ...
        KC_DEL, KC_END, KC_TAB, KC_PGDN, KC_SPC, KC_PCMM, KC_P1, KC_P2, KC_P3, KC_PEQL,
                LT(L_FN_NUM,KC_BSPC), LT(L_NAV,KC_PENT), LT(L_PUNCT,KC_P0), LT(L_NAV,KC_PDOT)),
    ...
    [L_MEDIA_KBD] = LAYOUT_split_3x5_2(
