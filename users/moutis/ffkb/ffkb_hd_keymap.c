...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT_ffkb(KC_NO, KC_W, KC_B, KC_M, KC_G, KC_LPRN, KC_RPRN, KC_DOT, KC_SLSH, KC_J, KC_QUOT, KC_NO, KC_NO, RCTL_T(KC_C), RALT_T(KC_S), RGUI_T(KC_N), RSFT_T(KC_T), LT(L_NUMPAD,KC_K), LT(L_FN_NUM,KC_COMM), RSFT_T(KC_A), RGUI_T(KC_E), RALT_T(KC_I), RCTL_T(KC_R), KC_NO, KC_NO, KC_P, KC_F, KC_L, KC_D, KC_V, KC_MINS, KC_U, KC_O, KC_Y, KC_X, KC_NO, LT(L_MEDIA_KBD,KC_MUTE), LT(L_FN_NUM,KC_BSPC), LT(L_NAV,KC_H), KC_APP, LT(L_MEDIA_KBD,KC_MPLY), LT(L_PUNCT,KC_SPC), LT(L_NAV,KC_ENT), LT(L_MEDIA_KBD,KC_MPLY), KC_NO),
	[1] = LAYOUT_ffkb(KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, RCTL_T(KC_H), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, LT(L_NAV,KC_R), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
	...
	[6] = LAYOUT_ffkb(KC_NO, QK_BOOT, EE_CLR, AG_SWAP, CG_SWAP, LCA(KC_DEL), SK_KILL, KC_NLCK, KC_EJCT, KC_NO, SK_ZOOMRST, KC_NO, KC_NO, RGB_TOG, KC_NO, HD_L_Bronze, HD_L_Titanium, HD_AdaptKeyToggle, KC_BRIU, KC_MPRV, KC_MUTE, KC_MNXT, SK_ZOOMOUT, KC_NO, KC_NO, AG_NORM, CG_NORM, KC_NO, KC_NO, KC_NO, KC_BRID, KC_MRWD, KC_MPLY, KC_MFFD, SK_ZOOMIN, KC_NO, KC_TRNS, AG_NORM, CG_NORM, KC_MUTE, KC_MPLY, KC_VOLD, KC_VOLU, KC_TRNS, KC_TRNS)
};
