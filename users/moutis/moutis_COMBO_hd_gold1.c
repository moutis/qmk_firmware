...
const uint16_t PROGMEM F_SCLP_combo[] = {KC_J, KC_K, COMBO_END}; // SCREEN shot SELECTION to clipboard
...
const uint16_t PROGMEM H_Q2_combo[] = {KC_W, KC_U, COMBO_END}; // TYPE "q"
const uint16_t PROGMEM H_LM_combo[] = {KC_M, KC_K, COMBO_END}; // TYPE "lm" (adaptive M is L after G)
...
const uint16_t PROGMEM Henye_combo[] = {KC_F, KC_K, COMBO_END}; // ˜ enye (dead key)
...
// Major
const uint16_t PROGMEM HUM_combo[] = {KC_M, KC_U, COMBO_END};  // Ü
const uint16_t PROGMEM HOM_combo[] = {KC_M, KC_O, COMBO_END};  // Ö
const uint16_t PROGMEM HUK_combo[] = {KC_K, KC_U, COMBO_END};  // Ů
const uint16_t PROGMEM HOK_combo[] = {KC_K, KC_O, COMBO_END};  // O̊
const uint16_t PROGMEM HUV_combo[] = {KC_V, KC_U, COMBO_END};  // Û
const uint16_t PROGMEM HOV_combo[] = {KC_V, KC_O, COMBO_END};  // Ô
const uint16_t PROGMEM HUF_combo[] = {KC_F, KC_U, COMBO_END};  // Ú
const uint16_t PROGMEM HOF_combo[] = {KC_F, KC_O, COMBO_END};  // Ó
