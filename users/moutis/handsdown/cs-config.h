...
//
//
//    Base (alpha) Layer  Hands Down Cesium (HRMs /+ thumb mods)
//            ╭─────────────────────╮                 ╭─────────────────────╮
// LANG1/mhen │  X   B   G   M   J  │ L_CFG     L_NUM │  #$  .:  /*  "[  '] │ LANG2/henk
//    esc     │  R   N   T   H   K  | (             ) |  ,;   A   E   I   S │ Z
//    tab     │  W   P   D   L   V  │ [ copy   pste ] │  -+   U   O   Y   F │ Q(u)
//            ╰───────────╮ bsp  C  │ &             | │ spc  ret ╭──────────╯
